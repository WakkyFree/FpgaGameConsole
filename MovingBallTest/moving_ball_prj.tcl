...
#
# moving_ball_prj.tcl: Tcl script for re-creating project 'moving_ball'
#
# by Wakky
#
#*****************************************************************************************
...
set _xil_proj_name_ "moving_ball"
...
set script_file "moving_ball_prj.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/moving_ball"]"
...
set files [list \
 [file normalize "${origin_dir}/rtl/ball_absolute_top.v"] \
