...
#
# tile_graphics_prj.tcl: Tcl script for re-creating project 'tile_graphics'
#
# by Wakky
#
#*****************************************************************************************
...
set _xil_proj_name_ "tile_graphics"
...
set script_file "tile_graphics_prj.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/tile_graphics"]"
...
set files [list \
 ...
 [file normalize "${origin_dir}/rtl/digits10_case.v"] \
 [file normalize "${origin_dir}/rtl/hvsync_generator.v"] \
 [file normalize "${origin_dir}/rtl/LFSR.v"] \
 [file normalize "${origin_dir}/rtl/RAM_sync.v"] \
 [file normalize "${origin_dir}/rtl/test_ram1_top.v"] \
